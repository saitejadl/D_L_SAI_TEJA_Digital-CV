...
# --- JOB 3
st.write('\n')
st.write("🚧","Regression with a Tabular Paris Housing Price Dataset] | Kaggle competition – Playground Series 3 Episode 6 (https://www.kaggle.com/competitions/playground-series-s3e6/leaderboard?search=sai+teja+dharmada)")
